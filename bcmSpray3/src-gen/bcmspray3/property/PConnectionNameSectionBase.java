/*************************************************************************************
 *
 * Generated on Mon Mar 25 16:34:01 CET 2013 by Spray PropertySection.xtend
 *
...
public abstract class PConnectionNameSectionBase extends GFPropertySection implements ITabbedPropertyConstants {

    protected PConnection bc = null;
    ...
    public void refresh() {
        ...
        if (pe != null) {
            ...
            // the filter assured, that it is a PConnection
            if (bo == null)
                return;
            bc = (PConnection) bo;
            String value = "";
