...
public abstract class ComponentNameSectionBase extends GFPropertySection implements ITabbedPropertyConstants {

    protected Component bc = null;
    ...
    public void refresh() {
        ...
        if (pe != null) {
            ...
            // the filter assured, that it is a Component
            if (bo == null)
                return;
            bc = (Component) bo;
            String value = "";
